...
def get_post_model():
    ...
    try:
        ...
        raise ImproperlyConfigured("BLOG_POST_MODEL must be of the form 'app_label.model_name'")
    except LookupError:
        raise ImproperlyConfigured(
            "BLOG_POST_MODEL refers to model '%s' that has not been installed" % settings.BLOG_POST_MODEL
        )
